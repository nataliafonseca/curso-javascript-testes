...
context('Store', () => {
  ...
  context('Store > Search for products', () => {
    ...
    it('should not return any products', () => {
      server.createList('product', 10);
  ...
  context('Store > Shopping Cart', () => {
    ...
    it('should toggle cart visibility on button click', () => {
    ...
    it('should add first product to the cart on button click', () => {
      gid('product-card').first().find('button').click();
    ...
    it('should clear cart on button click', () => {
      cy.addToCart({ indexes: [0, 1, 2, 3] });

      gid('cart-item').as('cartItems');

      g('@cartItems').should('have.length', 4);
    ...
    it('should increase quantity when + button gets clicked', () => {
      ...
      g('@quantity').contains(1);
      g('@+').click();
      g('@quantity').contains(2);
      g('@+').click();
      g('@quantity').contains(3);
    });
